...
% default these are not listed in the table of contents (hereafter TOC). The 
% macro '\acknowledgementsintoc' makes any following acknowledgements page 
% appear in the TOC.
...
% these are not listed in the TOC. The macro '\abstractintoc' makes any 
% following abstract page appear in the TOC.
%\abstractintoc
